...
public class LevelSceneTest extends LevelScene {
	...
	public LevelSceneTest(GraphicsConfiguration graphicsConfiguration, MarioComponent renderer, long seed,
			int levelDifficulty, int type, boolean isCustom) {
...
//				currentLevel = (Level) clg.generateLevel(gp);
				currentLevel = (Level) clg.generateLevel();
